...
from paddlenlp_ops import (  # get_token_penalty_multi_scores,; set_value_by_flags_and_idx,; set_value_by_flags_and_idx_v2,
    save_output,
    save_with_output,
...
class GenerationMedusaBlockInferenceModel(GenerationMixin):
    @classmethod
    def get_cache_kvs_shape(cls, max_batch_size: int = None, max_length: int = None) -> list[list[int]]:
        raise NotImplementedError
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        model_kwargs["pre_value_caches"] = pre_value_caches
        model_kwargs["src_mask"] = src_mask
        model_kwargs["cache_k"] = cache_k
        model_kwargs["cache_v"] = cache_v


        model_kwargs["medusa_k"] = medusa_k
        model_kwargs["medusa_v"] = medusa_v

        model_kwargs["medusa_attn_mask"] = medusa_attn_mask
        model_kwargs["tree_indices"] = tree_indices
        model_kwargs["medusa_position_ids"] = medusa_position_ids
        model_kwargs["retrieve_indices"] = retrieve_indices
