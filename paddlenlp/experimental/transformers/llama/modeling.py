    ...
    def set_state_dict(self, state_dict):
        ...
        for idx in range(self.config.num_hidden_layers):
            ...
            if self.use_weight_only:
                ...
                # print(type(qkv_weight_tensor))
                # print(type(paddle.base.framework._current_expected_place()))
                self.transformer_block.qkv_weights[idx].get_tensor()._copy_from_paddle_tensor(qkv_weight_tensor, paddle.base.framework._current_expected_place())
            else:
            ...
            if self.use_weight_only:
                ...
                self.transformer_block.linear_weights[idx].get_tensor()._copy_from_paddle_tensor(linear_weight_tensor, paddle.base.framework._current_expected_place())
            else:
            ...
            if self.use_weight_only:
                ...
                self.transformer_block.ffn1_weights[idx].get_tensor()._copy_from_paddle_tensor(ffn1_weight_tensor, paddle.base.framework._current_expected_place())
            else:
            ...
            if self.use_weight_only:
                ...
                self.transformer_block.ffn2_weights[idx].get_tensor()._copy_from_paddle_tensor(ffn2_weight_tensor, paddle.base.framework._current_expected_place())
            else:
